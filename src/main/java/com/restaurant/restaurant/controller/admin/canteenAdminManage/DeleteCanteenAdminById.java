...
@WebServlet("/deleteCanteenAdminById")
public class DeleteCanteenAdminById extends HttpServlet {
    @Override
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        String canteenAdminId = request.getParameter("canteenAdminId");
        response.getWriter().print(new CanteenAdminService().deleteCanteenAdminById(canteenAdminId));
    }
}

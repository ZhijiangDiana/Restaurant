...
public class Constants {
    ...
    public static final String COMMENTS_DEFAULT = "0";    // 默认评论展示
    public static final String COMMENTS_LIKES = "1";      // 按热度展示评论
    public static final String COMMENTS_TIME_ASC= "2";     // 按时间升序展示评论
    public static final String COMMENTS_TIME_DESC = "3";    // 按时间降序展示评论
